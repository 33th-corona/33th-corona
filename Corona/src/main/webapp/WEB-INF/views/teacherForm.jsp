								...
								<tr>
									...
									<th class="center">
										<c:if test="${uList.status eq 'request'}">
											<button num="${uList.num}" class="button button-rounded button-reveal button-small button-border button-orange tright nomargin commit"><i class="icon-angle-right" style="width: 20px "></i>승낙</button>
										</c:if>
									</th>
									<th class="center">
										<c:if test="${uList.status eq 'request'}">
											<button num="${uList.num}" class="button button-rounded button-reveal button-small button-border button-red tright nomargin withdraw"><i class="icon-angle-right" style="width: 20px "></i>거부</button>
										</c:if>
									</th>
							</c:forEach>
						</tbody>
